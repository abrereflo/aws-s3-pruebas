                    ...
                    <div class="row m-l-0 m-r-0">
                        <div class="col-sm-4 bg-c-lite-green user-profile">
                            <div class="card-block text-center text-white">
                                ...
                                <h6 class="f-w-600">Tipo de Producto</h6>
                                <p>{{$tipoproductos->name}}</p> <i class=" mdi mdi-square-edit-outline feather icon-edit m-t-10 f-16"></i>
                            </div>
                        </div>
                        <div class="col-sm-8">
                            <div class="card-block">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <p class="m-b-10 f-w-600">ID Tipo de Producto</p>
                                        <h6 class="text-muted f-w-400">{{$tipoproductos->id}}</h6>
                                    </div>
                                    <div class="col-sm-6">
                                        <p class="m-b-10 f-w-600">Estado</p>
                                        @if ($tipoproductos->statu == 1)
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <h6 class="text-muted f-w-400">{{$tipoproductos->description}}</h6>
                                    </div>
                                  {{--   <div class="col-sm-6">
                                ...
                                <div class="row">
                                    <a href="{{ route('producttype.index')}}" class="btn btn-info"><i class="fas fa-arrow-left"></i> Volver</a>
                                </div>
                            </div>
                        </div>
                    </div>
